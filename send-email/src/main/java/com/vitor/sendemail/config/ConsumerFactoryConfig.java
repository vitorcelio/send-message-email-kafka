...
public class ConsumerFactoryConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EnvioMensagemResponseDTO> concurrentContainerFactory(ConsumerFactory<String, EnvioMensagemResponseDTO> consumerFactory) {
